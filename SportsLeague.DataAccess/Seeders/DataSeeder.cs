    ...
    public static async Task SeedAsync(LeagueDbContext context)
    {
        ...
        var playersData = new (string First, string Last, PlayerPosition Pos, int Number)[][]
        {
            ...
            new[] {
                ...
                ("Andrés", "Gutiérrez", PlayerPosition.Defender, 4),
                ("Roberto", "Cortez", PlayerPosition.Defender, 5),
                ("William", "Vasquez", PlayerPosition.Midfielder, 6),
                ("Conejo", "Jaramillo", PlayerPosition.Midfielder, 7),
                ("David", "Montoya", PlayerPosition.Midfielder, 8),
                ("Mao", "Molina", PlayerPosition.Midfielder, 9),
                ("Jorge", "Serna", PlayerPosition.Forward, 10),
                ("Tressor", "Moreno", PlayerPosition.Forward, 11),
                ("Andrés", "Cadavid", PlayerPosition.Defender, 12),
                ("Adrián", "Arregui", PlayerPosition.Midfielder, 13),
                ("Luciano", "Pons", PlayerPosition.Forward, 14),
            },
            // 2. Atlético Nacional
            new[] {
                ("David", "Ospina", PlayerPosition.Goalkeeper, 1),
                ("William", "Tesillo", PlayerPosition.Defender, 2),
                ("Edwin", "Cardona", PlayerPosition.Defender, 3),
                ("Yo", "Morelos", PlayerPosition.Defender, 4),
                ("Tu", "Morelos", PlayerPosition.Defender, 5),
                ("El", "Morelos", PlayerPosition.Midfielder, 6),
                ("Nosotros", "Morelos", PlayerPosition.Midfielder, 7),
                ("Vosotros", "Morelos", PlayerPosition.Midfielder, 8),
                ("Ellos", "Morelos", PlayerPosition.Midfielder, 9),
                ("Ellas", "Morelos", PlayerPosition.Forward, 10),
                ("Ella", "Morelos", PlayerPosition.Forward, 11),
                ("Chupa", "Pijas", PlayerPosition.Goalkeeper, 12),
                ("Caco", "Rinsi", PlayerPosition.Defender, 13),
                ("Presta", "Culo", PlayerPosition.Midfielder, 14),
                ("Come", "Pichas", PlayerPosition.Forward, 15),
            },
            // 3. América de Cali
            new[] {

    ...
    public static async Task SeedAsync(LeagueDbContext context)
    {
        ...
        var playersData = new (string First, string Last, PlayerPosition Pos, int Number)[][]
        {
            ...
            new[] {
                ...
                ("Fabio", "Martinez", PlayerPosition.Defender, 4),
                ("Neider", "Parra", PlayerPosition.Defender, 5),
                ("Cristian", "Uribe", PlayerPosition.Midfielder, 6),
                ("Andres", "Roman", PlayerPosition.Midfielder, 7),
                ("Andres", "Marin", PlayerPosition.Midfielder, 8),
                ("Milton", "Casco", PlayerPosition.Midfielder, 9),
                ("Robinson", "García", PlayerPosition.Forward, 10),
                ("Mateus", "Uribe", PlayerPosition.Forward, 11),
                ("Juan", "Rengifo", PlayerPosition.Goalkeeper, 12),
                ("Simon", "García", PlayerPosition.Defender, 13),
                ("Juan", "Bauza", PlayerPosition.Midfielder, 14),
                ("Juan", "Zapata", PlayerPosition.Forward, 15),
            },
            // 3. América de Cali
            new[] {
